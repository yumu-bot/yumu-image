...
export const LABEL_PPP = {
    ...
    JUMP: {
        icon: readBinaryFromV3Cache('Icons', 'road-barrier-solid-full.svg'),
        title: 'JP',
        left_1: 'Jump',
        left_2: '跳',
        min: 0,
    ...
    FLOW: {
        icon: readBinaryFromV3Cache('Icons', 'wind-solid-full.svg'),
        title: 'FL',
        left_1: 'Flow',
        left_2: '串',
        min: 0,
    ...
    ACC: {
        icon: readBinaryFromV3Cache('Icons', 'arrows-to-dot-solid-full.svg'),
        title: 'AC',
        left_1: 'Accuracy',
        left_2: '准度',
        min: 0,
    ...
    STA: {
        icon: readBinaryFromV3Cache('Icons', 'heart-circle-bolt-solid-full.svg'),
        title: 'ST',
        left_1: 'Stamina',
        left_2: '耐力',
        min: 0,
    ...
    SPD: {
        icon: readBinaryFromV3Cache('Icons', 'gauge-high-solid-full.svg'),
        title: 'SP',
        left_1: 'Speed',
        left_2: '速度',
        min: 0,
    ...
    PRE: {
        icon: readBinaryFromV3Cache('Icons', 'crosshairs-solid-full.svg'),
        title: 'PR',
        left_1: 'Precision',
        left_2: '小圈',
        min: 0,
    ...
    OVA: {
        icon: readBinaryFromV3Cache('Icons', 'clipboard-list-solid-full.svg'),
        title: 'ALL',
        left_1: 'Overall',
        left_2: '综合',
        min: 0,
    ...
    AIM: {
        icon: readBinaryFromV3Cache('Icons', 'marker-solid-full.svg'),
        title: 'AIM',
        left_1: 'Aim',
        left_2: '移动',
        min: 0,
...
export const LABEL_MM = {
    ...
    RC: {
        icon: readBinaryFromV3Cache('Icons', 'bowl-rice-solid-full.svg'),
        title: 'RC',
        left_1: 'Rice',
        left_2: '米',
        min: 0,
    ...
    LN: {
        icon: readBinaryFromV3Cache('Icons', 'chart-simple-solid-full.svg'),
        title: 'LN',
        left_1: 'Long Note',
        left_2: '面',
        min: 0,
    ...
    CO: {
        icon: readBinaryFromV3Cache('Icons', 'hand-spock-solid-full.svg'),
        title: 'CO',
        left_1: 'Coordinate',
        left_2: '协调',
        min: 0,
    ...
    PR: {
        icon: readBinaryFromV3Cache('Icons', 'bullseye-solid-full.svg'),
        title: 'PR',
        left_1: 'Precision',
        left_2: '彩率',
        min: 0,
    ...
    SV: {
        icon: readBinaryFromV3Cache('Icons', 'spiral-solid-full.svg'),
        title: 'SV',
        left_1: 'S.Variation',
        left_2: '变速',
        min: 0,
    ...
    DN: {
        icon: readBinaryFromV3Cache('Icons', 'school-solid-full.svg'),
        title: 'DN',
        left_1: 'Dan Level',
        left_2: '段位',
        min: 0,
    ...
    UJ: {
        icon: readBinaryFromV3Cache('Icons', 'face-grin-squint-regular-full.svg'),
        title: 'UJ',
        left_1: 'Underjoy Dan',
        left_2: '长键段',
        min: 0,
    ...
    RG: {
        icon: readBinaryFromV3Cache('Icons', 'water-solid-full.svg'),
        title: 'RG',
    ...
    JL: {
        icon: readBinaryFromV3Cache('Icons', 'water-ladder-solid-full.svg'),
        title: 'JL',
...
export const LABEL_PPM6 = {
    ...
    PTT: {
        icon: readBinaryFromV3Cache('Icons', 'arrow-trend-up-solid-full.svg'),
        title: 'PTT',
        left_1: 'Potential',
        left_2: '潜力',
        min: 60,
    ...
    STB: {
        icon: readBinaryFromV3Cache('Icons', 'anchor-solid-full.svg'),
        title: 'STB',
        left_1: 'Stability',
        left_2: '稳定',
        min: 60,
    ...
    EFT: {
        icon: readBinaryFromV3Cache('Icons', 'street-view-solid-full.svg'),
        title: 'EFT',
        left_1: 'Effort',
        left_2: '肝力',
        min: 60,
    ...
    OII: {
        icon: readBinaryFromV3Cache('Icons', 'dna-solid-full.svg'),
        title: 'OII',
...
export const LABEL_ETX = {
    SR: {
        icon: getImageFromV3('Mods', 'td.png'),
        title: 'DR',
        left_1: 'Duel Rating',
        left_2: '星数',
        min: 4,
    ...
    NM: {
        icon: getImageFromV3('Mods', 'nm.png'),
        title: 'NM',
        left_1: 'No mod',
        left_2: '无模',
        min: 4,
    ...
    HD: {
        icon: getImageFromV3('Mods', 'hd.png'),
        title: 'HD',
        left_1: 'Hidden',
        left_2: '隐藏',
        min: 4,
    ...
    HR: {
        icon: getImageFromV3('Mods', 'hr.png'),
        title: 'HR',
        left_1: 'Hard Rock',
        left_2: '硬摇',
        min: 4,
    ...
    DT: {
        icon: getImageFromV3('Mods', 'dt.png'),
        title: 'DT',
        left_1: 'Double Time',
        left_2: '倍速',
        min: 4,
    ...
    FM: {
        icon: getImageFromV3('Mods', 'fi.png'),
        title: 'FM',
        left_1: 'Force Mod',
        left_2: '强模',
        min: 4,
    ...
    EF: {
        icon: getImageFromV3('Mods', 'cs.png'),
        title: 'EF',
        left_1: 'Effective',
        left_2: '有效',
        min: 0,
    ...
    PE: {
        icon: getImageFromV3('Mods', 'cl.png'),
        title: 'PE',
        left_1: 'Permanent',
        left_2: '永久',
        min: 0,
