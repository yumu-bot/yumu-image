...
export async function label_M3(data = {
  ...
  <g id="Text_LM3">
    ...
    const label1_x = hasLabel2 ? ((label_width / 2) - width_offset) : -(width_offset / 2) - (label_width * 3 / 2);
    const label2_x = label_width / 2;
    const label3_x = hasLabel2 ? ((label_width / 2) + width_offset) : (width_offset / 2) + (label_width * 3 / 2);
