import {getImage, getImageFromV3, setImage, setText, setTexts, thenPush} from "../util/util.js";
import {PuHuiTi} from "../util/font.js";
import {getMaimaiCover, getMaimaiRatingPlate} from "../util/maimai.js";

import {createImageRouter, createSvgRouter} from "../util/image.js";

export const router = createImageRouter(panel_Theta);

export const router_svg = createSvgRouter(panel_Theta);
