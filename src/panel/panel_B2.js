...
export async function panel_B2(data = {
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, s_arr).toFixed(3), 75 + 1370, -50 + 465, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, j_arr).toFixed(3), 75 + 1370 + 170, -50 + 465, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, b_arr).toFixed(3), 75 + 1370 + 340, -50 + 465, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, h_arr).toFixed(3), 75 + 1370, -50 + 465 + 115, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, o_arr).toFixed(3), 75 + 1370 + 170, -50 + 465 + 115, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, r_arr).toFixed(3), 75 + 1370 + 340, -50 + 465 + 115, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, e_arr).toFixed(3), 75 + 1370, -50 + 465 + 345, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, c_arr).toFixed(3), 75 + 1370 + 170, -50 + 465 + 345, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, d_arr).toFixed(3), 75 + 1370 + 340, -50 + 465 + 345, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, k_arr).toFixed(3), 75 + 1370, -50 + 465 + 460, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.max.apply(Math, i_arr).toFixed(3), 75 + 1370 + 170, -50 + 465 + 460, 24, 'center baseline', '#fff'), reg_right);
    ...
    svg = replaceText(svg, torus.getTextPath(Math.round(Math.max.apply(Math, u_arr)).toFixed(3), 75 + 1370 + 340, -50 + 465 + 460, 24, 'center baseline', '#fff'), reg_right);
