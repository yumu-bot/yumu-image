import {getPanelNameSVG, getSvgBody, readTemplate, setImage, setSvgBody, setText, thenPush} from "../util/util.js";
...
export const router = createImageRouter(panel_MI);
export const router_svg = createSvgRouter(panel_MI);
