...
export const router = createImageRouter(panel_A14);

export const router_svg = createSvgRouter(panel_A14);
 ...
 */
export async function panel_A14(
    data = {
        search: {
            beatmapsets: [{
                offset: 0,
    ...
    // 面板文字
    const panel_name = getPanelNameSVG('Explore Beatmap (!yme)', 'E');
