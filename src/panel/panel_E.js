    ...
    let label_ar =
        await label_E({
            ...
            data_m: (showPoint ? '' : (data.attr.ar % 1).toFixed(1).substring(2)) + (
                (labelChanged && (data.attr.ar !== data.label_data.ar)) ? ` (${data.label_data.ar})` : '')
        }, true);
    ...
    let label_od =
        await label_E({
            ...
            data_m: (showPoint ? '' : (data.attr.od % 1).toFixed(1).substring(2)) + (
                (labelChanged && (data.attr.od !== data.label_data.od)) ? ` (${data.label_data.od})` : '')
        }, true);
    ...
    let label_hp =
        await label_E({
            ...
            data_m: (showPoint ? '' : (data.attr.hp % 1).toFixed(1).substring(2)) + (
                (labelChanged && (data.attr.hp !== data.label_data.hp)) ? ` (${data.label_data.hp})` : '')
        }, true);
    let card_A1_impl =
