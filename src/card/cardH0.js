...
// 重写
export async function card_H0(data = {
    background: '',
    ...
    let p4_x = 815;
    let p4_y = 72;
    let p1 = p4_x - (torus.getTextWidth(data.pp_b,48) + torus.getTextWidth(data.pp_m,24)) / 2;
    let p2 = p4_x - torus.getTextWidth(data.pp_m,24) / 2 + torus.getTextWidth(data.pp_b,48) / 2;
