...
export async function card_A4(song = {
    "id": "8",
    ...
    // 读取模板
    let svg = `   <defs>
            <clipPath id="clippath-CA4-1">
              <rect x="135" width="310" height="175" rx="20" ry="20" style="fill: none;"/>
            </clipPath>
            <clipPath id="clippath-CA4-2">
              <rect width="175" height="175" rx="20" ry="20" style="fill: none;"/>
            </clipPath>
            <filter id="blur-CA4-1" height="120%" width="120%" x="-10%" y="-10%" filterUnits="userSpaceOnUse">
          ...
          <g id="Background_CA4">
            <g style="clip-path: url(#clippath-CA4-1);" filter="url(#blur-CA4-1)">
            </g>
          </g>
          <g id="Cover_CA4">
            <g style="clip-path: url(#clippath-CA4-2);">
            </g>
          </g>
          <g id="Text_CA4">
          </g>
    ...
    // 路径定义
    const reg_label = /(?<=<g id="Label_CA4">)/;
    const reg_text = /(?<=<g id="Text_CA4">)/;
    const reg_cover = /(?<=<g style="clip-path: url\(#clippath-CA4-2\);">)/;
    const reg_background = /(?<=<g style="clip-path: url\(#clippath-CA4-1\);" filter="url\(#blur-CA4-1\)">)/;
    const reg_base = /(?<=<g id="Base_CA4">)/;
